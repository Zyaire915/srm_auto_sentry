...
{
  std::lock_guard<std::mutex> lk(send_mutex_);
  send_robot_cmd_data_.speed_vector.vx = msg->linear.x*4;
  send_robot_cmd_data_.speed_vector.vy = msg->linear.y*4;
  send_robot_cmd_data_.speed_vector.wz = msg->angular.z*4;
}
