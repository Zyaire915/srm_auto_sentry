...
int main(int argc, char ** argv)
{
  ...
  // "到达回血点"由 TF2 计算机器人到 low_hp 点的实际距离（< 0.5m）判定
  // is_recovering 由 tick() 三态状态机决定（NORMAL→GOING_HOME→RECOVERING），仅 TF2 确认实际到达 low_hp 后才为 1
