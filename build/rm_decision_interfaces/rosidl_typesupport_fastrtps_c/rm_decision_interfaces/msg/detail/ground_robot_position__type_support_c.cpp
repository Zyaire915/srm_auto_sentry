...
#include "rm_decision_interfaces/msg/detail/ground_robot_position__rosidl_typesupport_fastrtps_c.h"
...
using _GroundRobotPosition__ros_msg_type = rm_decision_interfaces__msg__GroundRobotPosition;
...
size_t get_serialized_size_rm_decision_interfaces__msg__GroundRobotPosition(
  const void * untyped_ros_message,
...
static uint32_t _GroundRobotPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_decision_interfaces__msg__GroundRobotPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t max_serialized_size_rm_decision_interfaces__msg__GroundRobotPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces__msg__GroundRobotPosition;
    is_plain =
      (
...
static size_t _GroundRobotPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_decision_interfaces__msg__GroundRobotPosition(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_decision_interfaces, msg, GroundRobotPosition)() {
