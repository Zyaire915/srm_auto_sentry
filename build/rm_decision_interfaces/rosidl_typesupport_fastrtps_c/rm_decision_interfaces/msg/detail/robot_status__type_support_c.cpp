  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: is_attacked
  {
    cdr << (ros_message->is_attacked ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: is_attacked
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_attacked = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name is_attacked
  {
    size_t item_size = sizeof(ros_message->is_attacked);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
