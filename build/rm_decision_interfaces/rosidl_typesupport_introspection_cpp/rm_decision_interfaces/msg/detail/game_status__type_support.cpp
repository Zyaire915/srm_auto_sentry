...
{
  new (message_memory) rm_decision_interfaces::msg::GameStatus(_init);
}

void GameStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_decision_interfaces::msg::GameStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GameStatus_message_member_array[4] = {
  {
    ...
    offsetof(rm_decision_interfaces::msg::GameStatus, game_type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::GameStatus, game_progress),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::GameStatus, stage_remain_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::GameStatus, sync_time_stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GameStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(rm_decision_interfaces::msg::GameStatus),
...
get_message_type_support_handle<rm_decision_interfaces::msg::GameStatus>()
{
  return &::rm_decision_interfaces::msg::rosidl_typesupport_introspection_cpp::GameStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_decision_interfaces, msg, GameStatus)() {
  return &::rm_decision_interfaces::msg::rosidl_typesupport_introspection_cpp::GameStatus_message_type_support_handle;
}
