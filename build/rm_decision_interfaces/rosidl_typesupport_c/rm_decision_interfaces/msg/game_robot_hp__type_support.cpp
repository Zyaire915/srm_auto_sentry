...
static const _GameRobotHP_type_support_symbol_names_t _GameRobotHP_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_decision_interfaces, msg, GameRobotHP)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_decision_interfaces, msg, GameRobotHP)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_decision_interfaces, msg, GameRobotHP)() {
  return &::rm_decision_interfaces::msg::rosidl_typesupport_c::GameRobotHP_message_type_support_handle;
}
