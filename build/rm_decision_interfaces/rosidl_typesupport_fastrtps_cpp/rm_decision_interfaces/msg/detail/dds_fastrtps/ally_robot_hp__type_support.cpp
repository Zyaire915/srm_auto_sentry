...
#include "rm_decision_interfaces/msg/detail/ally_robot_hp__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_decision_interfaces::msg::AllyRobotHP & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces::msg::AllyRobotHP & ros_message)
{
  // Member: ally_1_robot_hp
  cdr >> ros_message.ally_1_robot_hp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces::msg::AllyRobotHP;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_decision_interfaces::msg::AllyRobotHP *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_decision_interfaces::msg::AllyRobotHP *>(
    untyped_ros_message);
...
{
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_AllyRobotHP__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, AllyRobotHP)() {
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_AllyRobotHP__handle;
}
