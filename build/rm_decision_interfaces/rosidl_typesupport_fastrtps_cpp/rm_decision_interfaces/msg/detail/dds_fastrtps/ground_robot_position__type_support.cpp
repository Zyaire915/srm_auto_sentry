...
#include "rm_decision_interfaces/msg/detail/ground_robot_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_decision_interfaces::msg::GroundRobotPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces::msg::GroundRobotPosition & ros_message)
{
  // Member: hero_x
  cdr >> ros_message.hero_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces::msg::GroundRobotPosition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_decision_interfaces::msg::GroundRobotPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_decision_interfaces::msg::GroundRobotPosition *>(
    untyped_ros_message);
...
{
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_GroundRobotPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, GroundRobotPosition)() {
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_GroundRobotPosition__handle;
}
