...
#include "rm_decision_interfaces/msg/detail/game_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_decision_interfaces::msg::GameStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces::msg::GameStatus & ros_message)
{
  // Member: game_type
  cdr >> ros_message.game_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces::msg::GameStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_decision_interfaces::msg::GameStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_decision_interfaces::msg::GameStatus *>(
    untyped_ros_message);
...
{
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_GameStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, GameStatus)() {
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_GameStatus__handle;
}
