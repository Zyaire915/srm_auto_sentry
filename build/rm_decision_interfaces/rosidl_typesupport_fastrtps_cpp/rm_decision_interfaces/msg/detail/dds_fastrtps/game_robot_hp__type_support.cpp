...
#include "rm_decision_interfaces/msg/detail/game_robot_hp__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_decision_interfaces::msg::GameRobotHP & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces::msg::GameRobotHP & ros_message)
{
  // Member: red_1_robot_hp
  cdr >> ros_message.red_1_robot_hp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces::msg::GameRobotHP;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_decision_interfaces::msg::GameRobotHP *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_decision_interfaces::msg::GameRobotHP *>(
    untyped_ros_message);
...
{
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_GameRobotHP__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, GameRobotHP)() {
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_GameRobotHP__handle;
}
