...
bool rm_decision_interfaces__msg__ground_robot_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_decision_interfaces.msg._ground_robot_position.GroundRobotPosition", full_classname_dest, 69) == 0);
  }
  rm_decision_interfaces__msg__GroundRobotPosition * ros_message = _ros_message;
  {  // hero_x
...
PyObject * rm_decision_interfaces__msg__ground_robot_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_decision_interfaces.msg._ground_robot_position");
