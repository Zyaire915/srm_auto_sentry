...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__GROUND_ROBOT_POSITION__STRUCT_HPP_
#define RM_DECISION_INTERFACES__MSG__DETAIL__GROUND_ROBOT_POSITION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rm_decision_interfaces__msg__GroundRobotPosition __attribute__((deprecated))
#else
# define DEPRECATED__rm_decision_interfaces__msg__GroundRobotPosition __declspec(deprecated)
#endif
...
struct GroundRobotPosition_
{
  ...
  // pointer types
  using RawPtr =
    rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator> *;
  using ConstRawPtr =
    const rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rm_decision_interfaces__msg__GroundRobotPosition
    std::shared_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rm_decision_interfaces__msg__GroundRobotPosition
    std::shared_ptr<rm_decision_interfaces::msg::GroundRobotPosition_<ContainerAllocator> const>
...
using GroundRobotPosition =
  rm_decision_interfaces::msg::GroundRobotPosition_<std::allocator<void>>;
...
#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__GROUND_ROBOT_POSITION__STRUCT_HPP_
