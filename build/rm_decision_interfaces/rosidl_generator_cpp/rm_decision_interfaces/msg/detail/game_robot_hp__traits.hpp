...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__GAME_ROBOT_HP__TRAITS_HPP_
#define RM_DECISION_INTERFACES__MSG__DETAIL__GAME_ROBOT_HP__TRAITS_HPP_
...
inline void to_yaml(
  const rm_decision_interfaces::msg::GameRobotHP & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rm_decision_interfaces::msg::GameRobotHP & msg)
{
  return rm_decision_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rm_decision_interfaces::msg::GameRobotHP>()
{
  return "rm_decision_interfaces::msg::GameRobotHP";
}

template<>
inline const char * name<rm_decision_interfaces::msg::GameRobotHP>()
{
  return "rm_decision_interfaces/msg/GameRobotHP";
}

template<>
struct has_fixed_size<rm_decision_interfaces::msg::GameRobotHP>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<rm_decision_interfaces::msg::GameRobotHP>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<rm_decision_interfaces::msg::GameRobotHP>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__GAME_ROBOT_HP__TRAITS_HPP_
