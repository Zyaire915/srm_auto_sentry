...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__GAME_ROBOT_HP__STRUCT_HPP_
#define RM_DECISION_INTERFACES__MSG__DETAIL__GAME_ROBOT_HP__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rm_decision_interfaces__msg__GameRobotHP __attribute__((deprecated))
#else
# define DEPRECATED__rm_decision_interfaces__msg__GameRobotHP __declspec(deprecated)
#endif
...
struct GameRobotHP_
{
  ...
  // pointer types
  using RawPtr =
    rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator> *;
  using ConstRawPtr =
    const rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rm_decision_interfaces__msg__GameRobotHP
    std::shared_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rm_decision_interfaces__msg__GameRobotHP
    std::shared_ptr<rm_decision_interfaces::msg::GameRobotHP_<ContainerAllocator> const>
...
using GameRobotHP =
  rm_decision_interfaces::msg::GameRobotHP_<std::allocator<void>>;
...
#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__GAME_ROBOT_HP__STRUCT_HPP_
