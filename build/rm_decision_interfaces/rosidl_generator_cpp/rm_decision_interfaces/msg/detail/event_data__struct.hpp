...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__EVENT_DATA__STRUCT_HPP_
#define RM_DECISION_INTERFACES__MSG__DETAIL__EVENT_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rm_decision_interfaces__msg__EventData __attribute__((deprecated))
#else
# define DEPRECATED__rm_decision_interfaces__msg__EventData __declspec(deprecated)
#endif
...
struct EventData_
{
  ...
  // pointer types
  using RawPtr =
    rm_decision_interfaces::msg::EventData_<ContainerAllocator> *;
  using ConstRawPtr =
    const rm_decision_interfaces::msg::EventData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rm_decision_interfaces::msg::EventData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rm_decision_interfaces__msg__EventData
    std::shared_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rm_decision_interfaces__msg__EventData
    std::shared_ptr<rm_decision_interfaces::msg::EventData_<ContainerAllocator> const>
...
using EventData =
  rm_decision_interfaces::msg::EventData_<std::allocator<void>>;
...
#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__EVENT_DATA__STRUCT_HPP_
