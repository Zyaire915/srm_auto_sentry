...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__RFID_STATUS__TRAITS_HPP_
#define RM_DECISION_INTERFACES__MSG__DETAIL__RFID_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const rm_decision_interfaces::msg::RfidStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rm_decision_interfaces::msg::RfidStatus & msg)
{
  return rm_decision_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rm_decision_interfaces::msg::RfidStatus>()
{
  return "rm_decision_interfaces::msg::RfidStatus";
}

template<>
inline const char * name<rm_decision_interfaces::msg::RfidStatus>()
{
  return "rm_decision_interfaces/msg/RfidStatus";
}

template<>
struct has_fixed_size<rm_decision_interfaces::msg::RfidStatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<rm_decision_interfaces::msg::RfidStatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<rm_decision_interfaces::msg::RfidStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__RFID_STATUS__TRAITS_HPP_
