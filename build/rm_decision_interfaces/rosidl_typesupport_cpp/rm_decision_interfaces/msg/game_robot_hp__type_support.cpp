...
static const _GameRobotHP_type_support_symbol_names_t _GameRobotHP_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, GameRobotHP)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_decision_interfaces, msg, GameRobotHP)),
  }
};
...
{
  return &::rm_decision_interfaces::msg::rosidl_typesupport_cpp::GameRobotHP_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_decision_interfaces, msg, GameRobotHP)() {
  return get_message_type_support_handle<rm_decision_interfaces::msg::GameRobotHP>();
}
