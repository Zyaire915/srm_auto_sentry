...
: ${AMENT_CURRENT_PREFIX:="/workspaces/auto_sentry/install/game_status_tester"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/game_status_tester/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/game_status_tester/environment/path.sh"
