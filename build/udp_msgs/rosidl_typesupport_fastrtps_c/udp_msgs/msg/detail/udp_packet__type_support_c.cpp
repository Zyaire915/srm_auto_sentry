...
#include "udp_msgs/msg/detail/udp_packet__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_udp_msgs
...
using _UdpPacket__ros_msg_type = udp_msgs__msg__UdpPacket;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UdpPacket__ros_msg_type * ros_message = static_cast<const _UdpPacket__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UdpPacket__ros_msg_type * ros_message = static_cast<_UdpPacket__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_udp_msgs__msg__UdpPacket(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UdpPacket__ros_msg_type * ros_message = static_cast<const _UdpPacket__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _UdpPacket__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_udp_msgs__msg__UdpPacket(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_udp_msgs
size_t max_serialized_size_udp_msgs__msg__UdpPacket(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = udp_msgs__msg__UdpPacket;
    is_plain =
      (
...
static size_t _UdpPacket__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_udp_msgs__msg__UdpPacket(
...
static message_type_support_callbacks_t __callbacks_UdpPacket = {
  "udp_msgs::msg",
  "UdpPacket",
...
static rosidl_message_type_support_t _UdpPacket__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UdpPacket,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udp_msgs, msg, UdpPacket)() {
  return &_UdpPacket__type_support;
}
