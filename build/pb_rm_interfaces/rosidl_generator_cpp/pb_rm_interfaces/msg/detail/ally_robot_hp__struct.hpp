...
#ifndef PB_RM_INTERFACES__MSG__DETAIL__ALLY_ROBOT_HP__STRUCT_HPP_
#define PB_RM_INTERFACES__MSG__DETAIL__ALLY_ROBOT_HP__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__pb_rm_interfaces__msg__AllyRobotHP __attribute__((deprecated))
#else
# define DEPRECATED__pb_rm_interfaces__msg__AllyRobotHP __declspec(deprecated)
#endif
...
struct AllyRobotHP_
{
  ...
  // pointer types
  using RawPtr =
    pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator> *;
  using ConstRawPtr =
    const pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__pb_rm_interfaces__msg__AllyRobotHP
    std::shared_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__pb_rm_interfaces__msg__AllyRobotHP
    std::shared_ptr<pb_rm_interfaces::msg::AllyRobotHP_<ContainerAllocator> const>
...
using AllyRobotHP =
  pb_rm_interfaces::msg::AllyRobotHP_<std::allocator<void>>;
...
#endif  // PB_RM_INTERFACES__MSG__DETAIL__ALLY_ROBOT_HP__STRUCT_HPP_
