...
bool pb_rm_interfaces__msg__ally_robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pb_rm_interfaces.msg._ally_robot_hp.AllyRobotHP", full_classname_dest, 47) == 0);
  }
  pb_rm_interfaces__msg__AllyRobotHP * ros_message = _ros_message;
  {  // ally_1_robot_hp
...
PyObject * pb_rm_interfaces__msg__ally_robot_hp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pb_rm_interfaces.msg._ally_robot_hp");
