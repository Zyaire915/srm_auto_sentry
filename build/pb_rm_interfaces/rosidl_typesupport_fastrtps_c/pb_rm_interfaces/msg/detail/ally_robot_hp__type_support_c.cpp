...
#include "pb_rm_interfaces/msg/detail/ally_robot_hp__rosidl_typesupport_fastrtps_c.h"
...
using _AllyRobotHP__ros_msg_type = pb_rm_interfaces__msg__AllyRobotHP;
...
size_t get_serialized_size_pb_rm_interfaces__msg__AllyRobotHP(
  const void * untyped_ros_message,
...
static uint32_t _AllyRobotHP__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pb_rm_interfaces__msg__AllyRobotHP(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pb_rm_interfaces
size_t max_serialized_size_pb_rm_interfaces__msg__AllyRobotHP(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pb_rm_interfaces__msg__AllyRobotHP;
    is_plain =
      (
...
static size_t _AllyRobotHP__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pb_rm_interfaces__msg__AllyRobotHP(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pb_rm_interfaces, msg, AllyRobotHP)() {
