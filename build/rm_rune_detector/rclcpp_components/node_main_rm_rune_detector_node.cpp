...
#define NODE_MAIN_LOGGER_NAME "rm_rune_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_rune_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_rune_detector::RMRuneDetectorNode>";
