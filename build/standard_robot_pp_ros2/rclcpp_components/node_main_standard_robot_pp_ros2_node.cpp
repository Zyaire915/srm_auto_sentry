...
#define NODE_MAIN_LOGGER_NAME "standard_robot_pp_ros2_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstandard_robot_pp_ros2.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<standard_robot_pp_ros2::StandardRobotPpRos2Node>";
